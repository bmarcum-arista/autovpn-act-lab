...
This topology is heavily inspired by the [Tech Library - AutoVPN Deployment Guide](https://tech-library.arista.com/wan/autovpn/deployment_guide/) with a bias toward [cv_deploy](https://avd.arista.com/stable/ansible_collections/arista/avd/roles/cv_deploy/index.html). These sites all have a single router and a single internet based underlay but can be extended to fit other use cases as needed.

For more advanced use cases that require [Application-aware Per-packet Steering / DMPO](https://arista.my.site.com/AristaCommunity/s/article/VeloCloud-SD-WAN-Dynamic-Multipath-Optimization-DMPO), consider [VeloCloud](https://www.arista.com/en/support/velocloud-resources).

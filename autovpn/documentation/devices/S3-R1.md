...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | default | 192.168.0.61/24 | - |
...
| ------------ | --------------------------------- | ------------------------- | ------------------- | ---------- |
| FLOW-TRACKER | 70000 | 300000 | 1 | Dps1<br>Ethernet1<br>Ethernet2 |
...
| --------- | ---------- | -------------- | -------- | --- | --------------- | --------------- |
| Dps1 | 10.1.5.101/32 | - | - | 9194 | Hardware: FLOW-TRACKER | - |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet1.70 | - | - | 10.70.70.1/24 | A | - | False | - | - |
| Ethernet2 | internet_inet-cloud | - | 192.5.101.2/30 | default | - | False | ACL-SPOKE-INTERNET-IN_Ethernet2 | - |
...
interface Ethernet2
   ...
   no switchport
   flow tracker hardware FLOW-TRACKER
   ip address 192.5.101.2/30
   ip access-group ACL-SPOKE-INTERNET-IN_Ethernet2 in
```
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.0.5.101/32 |
...
| --- | ------------------ | ----------- | -------------- | ----------------------- | --- | ---------- | ------ |
| default | 192.0.0.0/13 | 192.5.101.1 | - | 1 | - | - | - |

#### Static Routes Device Configuration

```eos
!
ip route 192.0.0.0/13 192.5.101.1
```
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.1.1.103 | Inherited from peer group WAN-OVERLAY-PEERS | default | - | Inherited from peer group WAN-OVERLAY-PEERS | Inherited from peer group WAN-OVERLAY-PEERS | - | Inherited from peer group WAN-OVERLAY-PEERS(interval: 1000, min_rx: 1000, multiplier: 10) | - | - | - | Inherited from peer group WAN-OVERLAY-PEERS |
| 10.1.2.103 | Inherited from peer group WAN-OVERLAY-PEERS | default | - | Inherited from peer group WAN-OVERLAY-PEERS | Inherited from peer group WAN-OVERLAY-PEERS | - | Inherited from peer group WAN-OVERLAY-PEERS(interval: 1000, min_rx: 1000, multiplier: 10) | - | - | - | Inherited from peer group WAN-OVERLAY-PEERS |
...
| --- | ------------------- | ------------ | ---------------- |
| A | 10.0.5.101:102 | connected | - |
| default | 10.0.5.101:101 | - | - |
...
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | ip address prefix-list PL-LOOPBACKS-EVPN-OVERLAY | extcommunity soo 10.0.5.101:140 additive | - | - |
...
| Sequence | Type | Match | Set | Sub-Route-Map | Continue |
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | - | extcommunity soo 10.0.5.101:140 additive | - | - |
...
route-map RM-CONN-2-BGP permit 10
   ...
   set extcommunity soo 10.0.5.101:140 additive
!
...
| --------- | ---- | -------------------- |
| ECL-EVPN-SOO | permit | soo 10.0.5.101:140 |

#### IP Extended Community Lists Device Configuration

```eos
ip extcommunity-list ECL-EVPN-SOO permit soo 10.0.5.101:140
```
...
```eos
!
ip access-list ACL-SPOKE-INTERNET-IN_Ethernet2
   1 remark Not for PRODUCTION: This ACL is built this way for the lab
   10 permit udp any host 192.5.101.2 eq isakmp non500-isakmp
   30 permit icmp any host 192.5.101.2
   deny ip any any
```
...
| Name | Prefixes |
| ---- | -------- |
| PFX-PATHFINDERS | 10.1.1.103/32<br>10.1.2.103/32 |
...
| -------------- | -------------- | ---------------------- |
| Ethernet2 | - | internet-EAST-R1-Ethernet2<br>internet-WEST-R1-Ethernet2 |
...
router path-selection
   ...
   path-group internet id 101
      ...
      local interface Ethernet2
         stun server-profile internet-EAST-R1-Ethernet2 internet-WEST-R1-Ethernet2
      !
      peer dynamic
      !
...
| -------------- | ---------- | ----------- | ---- |
| internet-EAST-R1-Ethernet2 | 192.2.103.2 | - | 3478 |
| internet-WEST-R1-Ethernet2 | 192.1.103.2 | - | 3478 |
...
stun
   client
      server-profile internet-EAST-R1-Ethernet2
         ip address 192.2.103.2
      server-profile internet-WEST-R1-Ethernet2
...
router adaptive-virtual-topology
  wan fabric
    peer role edge
      rule NoP2P region self zone self site exclude all
```

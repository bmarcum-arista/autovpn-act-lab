...
| --------- | ---------- | -------------- | -------- | --- | --------------- | --------------- |
| Dps1 | 10.1.1.103/32 | - | - | 9194 | Hardware: FLOW-TRACKER | - |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet1 | - | - | 21.101.103.103/24 | A | - | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 10.0.1.103/32 |
...
| --- | ------------------ | ----------- | -------------- | ----------------------- | --- | ---------- | ------ |
| default | 192.0.0.0/13 | 192.1.103.1 | - | 1 | - | - | - |

#### Static Routes Device Configuration

```eos
!
ip route 192.0.0.0/13 192.1.103.1
```
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.1.2.103 | Inherited from peer group WAN-RR-OVERLAY-PEERS | default | - | Inherited from peer group WAN-RR-OVERLAY-PEERS | Inherited from peer group WAN-RR-OVERLAY-PEERS | - | Inherited from peer group WAN-RR-OVERLAY-PEERS(interval: 1000, min_rx: 1000, multiplier: 10) | - | Inherited from peer group WAN-RR-OVERLAY-PEERS | - | Inherited from peer group WAN-RR-OVERLAY-PEERS |
| 21.101.103.101 | 65001 | A | - | - | - | - | - | - | - | - | - |
...
| --- | ------------------- | ------------ | ---------------- |
| A | 10.0.1.103:102 | connected | - |
| default | 10.0.1.103:101 | - | - |
...
router bgp 64512
   ...
   neighbor 10.1.2.103 peer group WAN-RR-OVERLAY-PEERS
   neighbor 10.1.2.103 description EAST-R1_Dps1
   ...
   vrf A
      ...
      router-id 10.0.1.103
      neighbor 21.101.103.101 remote-as 65001
      neighbor 21.101.103.101 description WEST-AGG
      redistribute connected
      !
      address-family ipv4
         neighbor 21.101.103.101 activate
   !
   vrf default
      rd 10.0.1.103:101
...
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | ip address prefix-list PL-LOOPBACKS-EVPN-OVERLAY | extcommunity soo 10.0.1.103:0 additive | - | - |
...
route-map RM-CONN-2-BGP permit 10
   ...
   set extcommunity soo 10.0.1.103:0 additive
!
...
| --------- | ---- | -------------------- |
| ECL-EVPN-SOO | permit | soo 10.0.1.103:0 |

#### IP Extended Community Lists Device Configuration

```eos
ip extcommunity-list ECL-EVPN-SOO permit soo 10.0.1.103:0
```
...
ip access-list ACL-HUB-INTERNET-IN_Ethernet2
   ...
   10 permit udp any host 192.1.103.2 eq isakmp non500-isakmp
   20 permit udp any host 192.1.103.2 eq 3478
   30 permit icmp any host 192.1.103.2
   deny ip any any
```
...
| Name | Prefixes |
| ---- | -------- |
| PFX-LOCAL-VTEP-IP | 10.1.1.103/32 |
...
| --------- | ---- | ---------------- |
| 10.1.2.103 | EAST-R1 | 192.2.103.2 |
